...
class TestCantidadEmpleados {
	...
	@Test
	void testCantidadEmpleadosDirector() {
		int cantidadEsperada = 15;
		int cantidadObtenida = this.director.getCantidadEmpleados();
		
		assertEquals(cantidadEsperada, cantidadObtenida);
	}

	@Test
	void testCantidadEmpleadosGerentes() {
		int cantidadEsperada = 5;
		int cantidadObtenida = this.gerente_RR_HH.getCantidadEmpleados();
		
		assertEquals(cantidadEsperada, cantidadObtenida);
	}
	
	@Test
	void testCantidadEmpleadosOperario() {
		int cantidadEsperada = 1;
		int cantidadObtenida = this.operario_ventas_1.getCantidadEmpleados();
